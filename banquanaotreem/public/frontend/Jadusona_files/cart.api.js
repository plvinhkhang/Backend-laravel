        ...
        if (key === 'items') {
          ...
          if (value.length) {
            ...
            jQuery.each(value, function(i, item) {
              ...
              jQuery('<li class="single-shopping-cart mb-20"><div class="shopping-cart-img"><a href="' + item.url + '"><img alt="" src="' + item.image + '"></a></div><div class="shopping-cart-title"><h3><a href="' + item.url + '">' + item.title + '</a></h3><span>' + Shopify.formatMoney(item.price, formatMoney) + '</span><a class="remove_btn" href="javascript:void(0);" onclick="Shopify.removeItem(' + item.variant_id + ')">x</a></div></li>').appendTo(table);
            });
          }
          else {
